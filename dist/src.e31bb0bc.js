...
var sections = [new _blocks.Block('title', 'Hello world!'), new _blocks.Block('text', loremText), new _blocks.Block('columns', [loremText, loremText, loremText]), new _blocks.Block('image', _profile.default)];
